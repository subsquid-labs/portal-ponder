...
| RG3 | Realtime chaos passed | **MET (Phase A, [#158](../../pull/158))** — 238 kills across 7 timing-class sub-runs, 238/238 clean resumes, byte-identical digests, 0 dup FINALIZED rows; K6-cutover non-vacuity + K2 kill-spread self-certified. Numbers + candid mock-fidelity caveats in VALIDATION §5.11. ≥200 kills across ≥6 timing classes, 100 % clean resumes, byte-identical digests |
