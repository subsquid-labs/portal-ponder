...
4. **The verdict is the offline re-diff of the evidence copies with the fixed tool.** Re-running the
   ...
   the full re-diff of all tables finished in ~90 s. Both tool variants' `sha256` digests were recorded
