...
- **Halve** — down to `PORTAL_MIN_CONCURRENCY` (8) — on any back-pressure signal: HTTP 429, any 5xx, a 409 on the finalized stream, a `retry-after`, or a dropped/timed-out connection.
