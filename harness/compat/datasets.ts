...
export const datasetForChain = (chainId: number): string | undefined =>
  NETWORKS[chainId]?.slug;
export const capsForChain = (chainId: number): NetworkCaps | undefined =>
  NETWORKS[chainId];
