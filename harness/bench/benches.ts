...
export const BENCHES: BenchSpec[] = [
  ...
  { name: "uniswap-portal HEAVY (50k blk)", dir: join(EX, "uniswap-portal"), schema: "bench_uniheavy", port: 42211,
    start: 22_200_000, end: 22_250_000, chainIds: [1], env: { PORTAL_URL: ETH }, timeoutMin: 12 },

  // first-party per-source-type benches (Ponder's own examples), Portal-routed
  { name: "feature-call-traces (traces)", dir: join(EX, "feature-call-traces"), schema: "bench_traces", port: 42202,
    start: 22_200_000, end: 22_205_000, chainIds: [1], env: { PORTAL_URL_1: ETH } },
  { name: "feature-blocks (block-interval)", dir: join(EX, "feature-blocks"), schema: "bench_blocks", port: 42203,
    start: 22_200_000, end: 22_210_000, chainIds: [1], env: { PORTAL_URL_1: ETH } },
  ...
  { name: "euler-mainnet (factory+lending)", dir: join(EX, "euler-mainnet"), schema: "bench_euler", port: 42204,
    start: 20_429_973, end: 20_490_000, chainIds: [1], env: { PORTAL_URL_1: ETH } },
  ...
  { name: "v4-ponder (uniswap v4, base)", dir: join(EX, "v4-ponder"), schema: "bench_v4", port: 42208,
    start: 25_350_988, end: 25_400_000, chainIds: [8453], env: { PORTAL_URL_8453: BASE }, timeoutMin: 12 },
];
